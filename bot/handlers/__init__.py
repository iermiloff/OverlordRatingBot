...
from .user_inventory import router as user_inventory_router  # ИСПРАВЛЕНО
...
from .manager_giveaways import router as manager_giveaways_router    # ИСПРАВЛЕНО
...
def get_main_router() -> Router:
    ...
    main_router.include_router(user_inventory_router)    # ИСПРАВЛЕНО
    ...
    main_router.include_router(manager_giveaways_router)  # ИСПРАВЛЕНО
